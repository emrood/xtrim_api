        ...
        <iq-card>
          ...
          <template v-slot:body>
            <ul class="suggestions-lists m-0 p-0">
              <li
                v-for="(invoice,index) in monthlyInvocie"
                :key="index"
              ...
              >
                ...
                <div class="media-support-info ml-3">
                  <h6>{{ invoice.title }}</h6>
                  <p class="mb-0">
                    <span :class="'text-' + invoice.color">{{ invoice.paid_month }} paid</span>
                    month out of {{ invoice.total_month }}
                  </p>
                </div>
                <div class="media-support-amount ml-3">
                  <h6>
                    <span :class="'text-' + invoice.color">$</span>
                    <b>{{ invoice.amount }}</b>
                  </h6>
        ...
        <b-row>
          <b-col md="6">
            <iq-card body-class="p-0">
              <template v-slot:body>
                <b-img
                  :src="require('../../assets/images/booking/booking-03.png')"
                  alt="03"
                  fluid
                  class="rounded"
                />
          ...
          <b-col md="6">
            <iq-card body-class="p-0">
              ...
              <template v-slot:body>
                <ApexChart
                  element="home-chart-01"
                  :chartOption="darkChart2"
                  v-if="$route.meta.dark"
                />

    ...
    <b-row>
        ...
        <iq-card>
          <template v-slot:body>
            <div class="text-center">
              <span>{{ $t('dashboard2.card1')}}</span>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <div class="value-box">
                <h2 class="mb-0">
                  <span class="counter">2.648</span>
                </h2>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="iq-card">
          <div class="iq-card-body">
            <div class="text-center">
              <span>{{ $t('dashboard2.card2')}}</span>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <div class="value-box">
                <h2 class="mb-0">
                  <span class="counter">89.6</span>
                </h2>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="iq-card">
          <div class="iq-card-body">
            <div class="text-center">
              <span>{{ $t('dashboard2.card3')}}</span>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <div class="value-box">
                <h2 class="mb-0">
                  <span class="counter">826</span>
                </h2>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="iq-card">
          <div class="iq-card-body">
            <div class="text-center">
              <span>{{ $t('dashboard2.card4')}}</span>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <div class="value-box">
                <h2 class="mb-0">
                  <span class="counter">7.55</span>
                </h2>
          ...
          <template v-slot:body>
            <b-table responsive :items="items" class="mb-0 table-borderless">
              ...
              <template v-slot:cell(progress)="data1">
                <b-progress
                  :value="data1.value.count"
                  class="iq-progress-bar"
                  :variant="data1.value.color"
                ></b-progress>
              </template>
            </b-table>
          </template>
            ...
            <Slick id="post-slider">
              <li class="d-flex align-items-center">
                <div class="post-image">
                  <a href="javascript:void(0);">
                    <img
                      :src="require('../../assets/images/page-img/p-2.jpg')"
                      alt="post-image"
                  ...
                  <div class="text-center d-flex align-items-center justify-content-between">
                    <div class="iq-post-likes text-left">
                      <a href="#" class="text-secondary">
                        <i class="ri-heart-line mr-2" />6.2K
                      </a>
                    </div>
                    <div class="iq-post-comments text-left ml-2 mr-2">
                      <a href="#" class="text-secondary">
                        <i class="ri-chat-1-fill mr-2" />6.2K
                      </a>
                    </div>
                    <div class="iq-post-save text-left">
                      <a href="#" class="text-secondary">
                        <i class="ri-save-line mr-2" />6.2K
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <li class="d-flex align-items-center">
                <div class="post-image">
                  <a href="javascript:void(0);">
                    <img
                      :src="require('../../assets/images/page-img/p-3.jpg')"
                      alt="post-image"
                      class="img-fluid rounded"
                    />
                  </a>
                ...
                <div class="post-content pl-3">
                  ...
                  <div class="text-center d-flex align-items-center justify-content-between">
                    <div class="iq-post-likes text-left">
                      <a href="#" class="text-secondary">
                        <i class="ri-heart-line mr-2"></i>6.2K
                      </a>
                    </div>
                    <div class="iq-post-comments text-left ml-2 mr-2">
                      <a href="#" class="text-secondary">
                        <i class="ri-chat-1-fill mr-2"></i>6.2K
                      </a>
                    </div>
                    <div class="iq-post-save text-left">
                      <a href="#" class="text-secondary">
                        <i class="ri-save-line mr-2"></i>6.2K
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <li class="d-flex align-items-center">
                <div class="post-image">
                  <a href="javascript:void(0);">
                    <img
                      :src="require('../../assets/images/page-img/p-4.jpg')"
                      alt="post-image"
                      class="img-fluid rounded"
                    />
                  </a>
              ...
              <li class="d-flex align-items-center">
                <div class="post-image">
                  <a href="javascript:void(0);">
                    <img
                      :src="require('../../assets/images/page-img/p-5.jpg')"
                      alt="post-image"
                      class="img-fluid rounded"
                    />
                  </a>

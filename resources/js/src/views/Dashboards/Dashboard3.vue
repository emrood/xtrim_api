            ...
            <div class="iq-details mt-3">
              ...
              <div class="iq-progress-bar-linear d-inline-block w-100">
                <div class="iq-progress-bar">
                  <b-progress height="5px" :value="75" variant="success" ></b-progress>
                </div>
              </div>
            </div>
            <div class="iq-details mt-3">
              ...
              <div class="iq-progress-bar-linear d-inline-block w-100">
                <div class="iq-progress-bar">
                  <b-progress height="5px" :value="72" variant="info"></b-progress>
                </div>
              </div>
            </div>
            </template>
              ...
              <template v-slot:body>
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <div class="col-sm-6">
                    ...
                    <div class="iq-progress-bar-linear d-inline-block w-100">
                      <div class="iq-progress-bar">
                        <b-progress height="5px" :value="75" variant="primary" ></b-progress>
                      </div>
                    </div>
                  </div>
                  <b-col sm="6">
                    ...
                    <div class="iq-progress-bar-linear d-inline-block w-100">
                      <div class="iq-progress-bar">
                        <b-progress height="5px" :value="25" variant="warning"></b-progress>
                      </div>
                    </div>
                  </b-col>
                </div>

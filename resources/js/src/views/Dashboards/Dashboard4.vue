          ...
          <iq-card>
            ...
            <template v-slot:body>
              <div class="iq-details">
                ...
                <div class="iq-progress-bar-linear d-inline-block w-100">
                  <div class="iq-progress-bar">
                    <b-progress height="5px" :value="95" variant="primary" ></b-progress>
                  </div>
                </div>
              </div>
              <div class="iq-details mt-4">
                ...
                <div class="iq-progress-bar-linear d-inline-block w-100">
                  <div class="iq-progress-bar">
                    <b-progress height="5px" :value="75" variant="warning" ></b-progress>
                  </div>
                </div>
              </div>
              <div class="iq-details mt-4">
                ...
                <div class="iq-progress-bar-linear d-inline-block w-100">
                  <div class="iq-progress-bar">
                    <b-progress height="5px" :value="55" variant="success" ></b-progress>
                  </div>
                </div>
              </div>
              <div class="iq-details mt-4">
                ...
                <div class="iq-progress-bar-linear d-inline-block w-100">
                  <div class="iq-progress-bar">
                    <b-progress height="5px" :value="25" variant="info" ></b-progress>
                  </div>
                </div>
              </div>
              <div class="iq-details mt-4">
                ...
                <div class="iq-progress-bar-linear d-inline-block w-100">
                  <div class="iq-progress-bar">
                    <b-progress height="5px" :value="10" variant="danger" ></b-progress>
                  </div>
                </div>
              </div>
            </template>
...
export default {
  ...
  mounted () {
    core.index()
    // core.bodyClassCheck('top-tab-horizontal')
  },
  components: { AmChart }
}
</script>

            ...
            <div class="row align-items-center justify-content-center">
              ...
              <div class="col-md-7 iq-item-product-right">
                <div class="product-additional-details">
                  ...
                  <p>
                    By
                    <b>{{ selectedProductState.brand}}</b>
                  </p>
                  <div class="ratting">
                  ...
                  <div class="product-price">
                    <div class="regular-price">
                      <b>$ {{ selectedProductState.price }}</b>
                      <span class="offer-price ml-2">$ {{ selectedProductState.price - 10}}</span>
                    </div>
                  </div>
                  <div class="shipping">
                    <p class="mb-0" v-if="selectedProductState.free_shipping">
                      Shipping Fee:
                      <span>Free</span>
                    </p>
                    <p class="mb-0" v-else>
                  ...
                  <div class="additional-product-action d-flex align-items-center">
                    <div class="product-action">
                      <div class="add-to-cart">
                        <b-button
                          v-if="checkCart(selectedProductState)"
                          @click="$router.push({name: 'app.e-commerce.cart'})"
                          variant=" iq-bg-primary"
                        >
                          <i class="fas fa-eye" /> View Cart
                        </b-button>
                        <b-button variant="primary" @click="addCart(selectedProductState)" v-else>
                          <i class="fas fa-cart-plus" /> Add to Cart
                        </b-button>
                      </div>
                      <div class="wishlist">
                        <b-button
                          variant=" iq-bg-primary ml-2"
                          v-if="wishCart(selectedProductState)"
                          @click="addToWishlist(selectedProductState)"
                        >
                          <i class="fas fa-heart" />Wishlist
                        </b-button>
                        <b-button
                          variant="primary ml-2"
                          @click="addWishlist(selectedProductState)"
                          v-else
                        >
                ...
                <li class="product_item p-2" v-for="item in related" :key="item.value">
                  <iq-card>
                    <ProductGrid
                      :item="item"
                      @cart="addToCart"
                      :selectedCart="checkCart(item)"
                      @wishlist="addToWishlist"
                      :selectedWishCart="wishCart(item)"
                    />
                  </iq-card>
                </li>
              </Slick>
...
export default {
      ...
      related: [
        {
          ...
          _highlightResult: {
            ...
            categories: [
              ...
              { value: "All Laptops", matchLevel: "none", matchedWords: [] },
              { value: "MacBooks", matchLevel: "none", matchedWords: [] }
            ],
            type: { value: "Apple", matchLevel: "none", matchedWords: [] }
          },
          __position: 5
        },
        {
          ...
          brand: "Sharp",
          categories: ["TV & Home Theater", "TVs", "All Flat-Panel TVs"],
          hierarchicalCategories: {
          ...
          _highlightResult: {
            ...
            brand: { value: "Sharp", matchLevel: "none", matchedWords: [] },
            categories: [
              {
        ...
        },
        {
          ...
          _highlightResult: {
            ...
            brand: { value: "Google", matchLevel: "none", matchedWords: [] },
            categories: [
              { value: "Smart Home", matchLevel: "none", matchedWords: [] }
            ],
            type: {
        ...
        },
        {
          ...
          _highlightResult: {
            ...
            brand: { value: "Dell", matchLevel: "none", matchedWords: [] },
            categories: [
              {
                value: "Computers &amp; Tablets",
                matchLevel: "none",
            ...
            type: { value: "Burst skus", matchLevel: "none", matchedWords: [] }
          },
          __position: 3
        }
      ],
  ...
  methods: {
    ...
    checkCart(item) {
      let cartItem = this.stateCart.find(
        cart => cart.objectID === item.objectID
      );
      return cartItem !== undefined && cartItem !== null;
    },
    wishCart(item) {
      let wishlistItem = this.stateWishlist.find(
        cart => cart.objectID === item.objectID
      );

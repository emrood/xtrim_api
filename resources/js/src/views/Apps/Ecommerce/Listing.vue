                      ...
                      <iq-card>
                        <div class="d-flex align-items-center justify-content-between pl-2 pr-3">
                          <div class="d-flex iq-algolia-search">
                            <ais-search-box id="searchbox" show-loading-indicator></ais-search-box>
                          ...
                          <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                              <b-button
                                :variant="`${listType === 'grid' ? 'primary' : ' iq-bg-primary'}`"
                                class="mr-2"
                                @click="listType = 'grid'"
                              >
                                <i class="ri-grid-fill mr-0" />
                              </b-button>
                              <b-button
                                :variant="`${listType === 'list' ? 'primary' : ' iq-bg-primary'}`"
                                class
                                @click="listType = 'list'"
                              >
                                <i class="ri-list-unordered mr-0" />
                              </b-button>
                            </div>
                          </div>
                        </div>
...
export default {
  ...
  data() {
    return {
      listType: "grid",
      searchClient: algoliasearch(APP_ID, APP_KEY)
    };
  },
  methods: {

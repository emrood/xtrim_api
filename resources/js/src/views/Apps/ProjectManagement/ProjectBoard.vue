        ...
        <div class="row">
          <div class="col-md-12 track">
            <iq-card
              ...
              class="bg-transparent shadow-none mr-3 w-25"
              :headerClass="item.color"
            ...
            >
              ...
              <template v-slot:headerAction>
                <i
                  class="ri-ball-pen-line mr-0 font-size-18"
                  v-b-modal.board
              ...
              <template v-slot:body>
                <draggable :list="item.list" group="scrumboard" @change="log">
                  ...
                  >
                    ...
                    <template v-slot:headerAction>
                      <a
                        class="badge iq-bg-primary mr-2 p-2"
                        v-if="element.status === 0"
                        href="#"
                      >Low</a>
                      <a
                        class="badge iq-bg-warning mr-2 p-2"
                        v-if="element.status === 1"
                        href="#"
                      >High</a>
                      <a
                        class="badge iq-bg-danger mr-2 p-2"
                    ...
                    <template v-slot:body>
                      ...
                      <div class="d-flex justify-content-between">
                        <div>
                          <i
                            class="ri-ball-pen-line font-size-18"
                            v-b-modal.task
                            @click="editTask(element,item)"
                          />
                          <i class="ri-attachment-line font-size-18 ml-2" />
                          <i class="ri-eye-line font-size-18 ml-2" />
                          <span>
                            <small>54</small>
                          </span>
                          <i class="ri-chat-4-line font-size-18 ml-2" />
                          <span>
                            <small>36</small>
                          </span>
      ...
      boards: [
        {
          ...
          list: [
            ...
            },
            {
              ...
              name: "Joao",
              description:
                " Lstandard dummy text ever since the 1500s dummy text of the printing and",
              status: 2,
              date: "2020-01-3"
            }
          ]

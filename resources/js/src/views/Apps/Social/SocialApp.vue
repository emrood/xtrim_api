                ...
                <iq-card>
                  ...
                  <template v-slot:headerAction>
                    <b-dropdown id="dropdownMenuButton5" right variant="none">
                      ...
                      <b-dropdown-item href="#">
                        <i class="ri-close-circle-line mr-2"></i>Delete
                      </b-dropdown-item>
                      <b-dropdown-item href="#">
                      ...
                      >
                        ...
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                          ...
                          >
                            ...
                            <b-dropdown-item href="#">
                              <i class="ri-user-unfollow-line mr-2"></i>Unfollow
                            </b-dropdown-item>
                            <b-dropdown-item href="#">
                              <i class="ri-share-forward-line mr-2"></i>Share
                            </b-dropdown-item>
                            <b-dropdown-item href="#">
                              <i class="ri-file-copy-line mr-2"></i>Copy Link
                            </b-dropdown-item>
                          </b-dropdown>
                        </div>
                      </li>
                  ...
                  <template v-slot:body>
                    <div class="user-detail text-center">
                      ...
                      <div class="profile-detail mt-3">
                        ...
                        <p
                          class="mb-0"
                        >Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 500s</p>
                      </div>
                    </div>
                  </template>
                </iq-card>
              ...
              <template v-slot:body>
                <div class="about-info m-0 p-0">
                  <b-row>
                    ...
                    <b-col cols="9">
                      <b-link v-bind:href="user.email">nikjone@demoo.com</b-link>
                    </b-col>
                    <b-col cols="3">Phone:</b-col>
                    <b-col cols="9">
                      <b-link v-bind:href="user.phone">001 2351 256 12</b-link>
                    </b-col>
